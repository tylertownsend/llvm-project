...
- [x] M4-14 Add reproducibility tests for lockfile replay in CI.
...
- [x] M5-08 Add fix-its for common restriction diagnostics (where safe).
- [x] M5-09 Add IDE integration tests to CI with representative cNxt projects.
