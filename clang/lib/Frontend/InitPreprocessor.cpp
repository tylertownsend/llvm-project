...
static void AddImplicitCNxtPrelude(MacroBuilder &Builder) {
  ...
  Builder.append("  unique(unique &&) = default;");
  Builder.append("  unique &operator=(const unique &) = delete;");
  Builder.append("  unique &operator=(unique &&) = default;");
  ...
  Builder.append("  shared(const shared &) = default;");
  Builder.append("  shared(shared &&) = default;");
  Builder.append("  shared &operator=(const shared &) = default;");
  Builder.append("  shared &operator=(shared &&) = default;");
  Builder.append("  T *get() const { return Ptr; }");
  Builder.append("  void reset(T *P = nullptr) { Ptr = P; }");
  ...
  Builder.append("  weak(const shared<T> &Owner) : Ptr(Owner.get()) {}");
  Builder.append("  shared<T> lock() const {");
  Builder.append("    shared<T> Owner;");
