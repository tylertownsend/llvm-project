...
static void AddImplicitCNxtPrelude(MacroBuilder &Builder) {
  ...
  Builder.append("  unique(unique &&Other) : Ptr(Other.Ptr) { Other.Ptr = nullptr; }");
  ...
  Builder.append("    Ptr = nullptr;");
  Builder.append("    return Tmp;");
  Builder.append("  }");
  Builder.append("  void reset(T *P = nullptr) {");
  Builder.append("    if (Ptr == P)");
  Builder.append("      return;");
  Builder.append("    __cnxt_rt_own_v1_unique_drop(static_cast<void *>(Ptr),");
  Builder.append("                                 __cnxt_payload_dtor<T>(),");
  Builder.append("                                 __cnxt_payload_size<T>(),");
  Builder.append("                                 __cnxt_payload_align<T>());");
  ...
  Builder.append("  explicit shared(void *RawControl, int) : Control(RawControl) {}");
  ...
  Builder.append("  shared(const shared &Other) : Control(Other.Control) {");
  Builder.append("    __cnxt_rt_own_v1_shared_retain(Control);");
  Builder.append("  }");
  Builder.append("  shared(shared &&Other) : Control(Other.Control) {");
  ...
  Builder.append("    return static_cast<T *>(__cnxt_rt_own_v1_shared_get(Control));");
  Builder.append("  }");
  Builder.append("  void reset(T *P = nullptr) {");
  ...
  Builder.append("      static_cast<void *>(Owner.release()), __cnxt_payload_dtor<T>(),");
  Builder.append("      __cnxt_payload_size<T>(), __cnxt_payload_align<T>());");
  Builder.append("  return shared<T>(Control, 0);");
  Builder.append("}");
  Builder.append("template <typename T> struct weak {");
  Builder.append("private:");
  Builder.append("  void *Control = nullptr;");
  ...
  Builder.append("  weak(const weak &Other) : Control(Other.Control) {");
  Builder.append("    __cnxt_rt_own_v1_weak_retain(Control);");
  Builder.append("  }");
  Builder.append("  weak(weak &&Other) : Control(Other.Control) {");
  Builder.append("    Other.Control = nullptr;");
  Builder.append("  }");
  ...
  Builder.append("    return *this;");
  Builder.append("  }");
  Builder.append("  weak(const shared<T> &Owner) : Control(Owner.Control) {");
  Builder.append("    __cnxt_rt_own_v1_weak_retain(Control);");
  Builder.append("  }");
  Builder.append("  shared<T> lock() const {");
  Builder.append("    return shared<T>(__cnxt_rt_own_v1_weak_lock(Control), 0);");
  Builder.append("  }");
