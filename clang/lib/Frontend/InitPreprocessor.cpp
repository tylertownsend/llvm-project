...
static void AddImplicitCNxtPrelude(MacroBuilder &Builder) {
  ...
  Builder.append("                                  unsigned long long align);");
  Builder.append("void *__cnxt_rt_own_v1_shared_from_unique(");
  Builder.append("    void *object, void (*dtor)(void *), unsigned long long size,");
  Builder.append("    unsigned long long align);");
  Builder.append("void __cnxt_rt_own_v1_shared_retain(void *control);");
  Builder.append("void __cnxt_rt_own_v1_shared_release(void *control);");
  Builder.append("void *__cnxt_rt_own_v1_shared_get(void *control);");
  Builder.append("void __cnxt_rt_own_v1_weak_retain(void *control);");
  ...
  Builder.append("template <typename T>");
  Builder.append("inline void __cnxt_destroy_payload(void *Object) {");
  Builder.append("  static_cast<T *>(Object)->~T();");
  Builder.append("}");
  Builder.append("template <typename T>");
  Builder.append("inline void (*__cnxt_payload_dtor())(void *) {");
  Builder.append("  if constexpr (__is_complete_type(T)) {");
  Builder.append("    if constexpr (!__is_trivially_destructible(T))");
  Builder.append("      return &__cnxt_destroy_payload<T>;");
  Builder.append("  }");
  Builder.append("  return nullptr;");
  Builder.append("}");
  Builder.append("template <typename T>");
  Builder.append("inline unsigned long long __cnxt_payload_size() {");
  Builder.append("  if constexpr (__is_complete_type(T))");
  Builder.append("    return static_cast<unsigned long long>(sizeof(T));");
  Builder.append("  return 0;");
  Builder.append("}");
  Builder.append("template <typename T>");
  Builder.append("inline unsigned long long __cnxt_payload_align() {");
  Builder.append("  if constexpr (__is_complete_type(T))");
  Builder.append("    return static_cast<unsigned long long>(alignof(T));");
  Builder.append("  return 0;");
  Builder.append("}");
  Builder.append("template <typename T> struct __cnxt_iface_witness {");
  Builder.append("  const void *Table = nullptr;");
  Builder.append("};");
  Builder.append("template <typename T> struct __cnxt_iface_borrowed {");
  Builder.append("private:");
  Builder.append("  void *Object = nullptr;");
  ...
  Builder.append("                        const __cnxt_iface_witness<T> *RawWitness)");
  Builder.append("      : Object(RawObject), Witness(RawWitness) {}");
  Builder.append("  void *__object() const { return Object; }");
  Builder.append("  const __cnxt_iface_witness<T> *__witness() const { return Witness; }");
  Builder.append("};");
  Builder.append("template <typename T> struct unique {");
  Builder.append("private:");
  Builder.append("  void *Storage = nullptr;");
  Builder.append("  T *View = nullptr;");
  Builder.append("  void (*Dtor)(void *) = nullptr;");
  Builder.append("  unsigned long long Size = 0;");
  Builder.append("  unsigned long long Align = 0;");
  Builder.append("  template <typename U> friend struct unique;");
  Builder.append("  template <typename U> friend struct shared;");
  Builder.append("  template <typename U> friend struct weak;");
  Builder.append("  template <typename U> friend shared<U> share(unique<U> &&Owner);");
  Builder.append("public:");
  Builder.append("  unique() = default;");
  Builder.append("  unique(const unique &) = delete;");
  Builder.append("  unique(unique &&Other)");
  Builder.append("      : Storage(Other.Storage), View(Other.View), Dtor(Other.Dtor),");
  Builder.append("        Size(Other.Size), Align(Other.Align) {");
  Builder.append("    Other.Storage = nullptr;");
  Builder.append("    Other.View = nullptr;");
  Builder.append("    Other.Dtor = nullptr;");
  Builder.append("    Other.Size = 0;");
  Builder.append("    Other.Align = 0;");
  Builder.append("  }");
  Builder.append("  template <typename U,");
  Builder.append("            typename = decltype(static_cast<T *>(");
  Builder.append("                static_cast<U *>(nullptr)))>");
  Builder.append("  unique(unique<U> &&Other)");
  Builder.append("      : Storage(Other.Storage), View(static_cast<T *>(Other.View)),");
  Builder.append("        Dtor(Other.Dtor), Size(Other.Size), Align(Other.Align) {");
  Builder.append("    Other.Storage = nullptr;");
  Builder.append("    Other.View = nullptr;");
  Builder.append("    Other.Dtor = nullptr;");
  Builder.append("    Other.Size = 0;");
  Builder.append("    Other.Align = 0;");
  Builder.append("  }");
  Builder.append("  unique &operator=(const unique &) = delete;");
  Builder.append("  unique &operator=(unique &&Other) {");
  Builder.append("    if (this == &Other)");
  Builder.append("      return *this;");
  Builder.append("    reset();");
  Builder.append("    Storage = Other.Storage;");
  Builder.append("    View = Other.View;");
  Builder.append("    Dtor = Other.Dtor;");
  ...
  Builder.append("            typename = decltype(static_cast<T *>(");
  Builder.append("                static_cast<U *>(nullptr)))>");
  Builder.append("  unique &operator=(unique<U> &&Other) {");
  Builder.append("    reset();");
  Builder.append("    Storage = Other.Storage;");
  Builder.append("    View = static_cast<T *>(Other.View);");
  Builder.append("    Dtor = Other.Dtor;");
  Builder.append("    Size = Other.Size;");
  Builder.append("    Align = Other.Align;");
  Builder.append("    Other.Storage = nullptr;");
  ...
  Builder.append("  T *get() const { return View; }");
  Builder.append("  T *release() {");
  Builder.append("    T *Tmp = View;");
  Builder.append("    Storage = nullptr;");
  Builder.append("    View = nullptr;");
  Builder.append("    Dtor = nullptr;");
  Builder.append("    Size = 0;");
  Builder.append("    Align = 0;");
  Builder.append("    return Tmp;");
  Builder.append("  }");
  Builder.append("  void *__storage() const { return Storage; }");
  Builder.append("  T *__view() const { return View; }");
  Builder.append("  void (*__dtor() const)(void *) { return Dtor; }");
  Builder.append("  unsigned long long __size() const { return Size; }");
  Builder.append("  unsigned long long __align() const { return Align; }");
  Builder.append("  void *__release_storage() {");
  Builder.append("    void *Tmp = Storage;");
  Builder.append("    Storage = nullptr;");
  Builder.append("    View = nullptr;");
  Builder.append("    Dtor = nullptr;");
  Builder.append("    Size = 0;");
  ...
  Builder.append("    return Tmp;");
  Builder.append("  }");
  Builder.append("  __cnxt_iface_borrowed<T> __borrowed() const {");
  Builder.append("    return __cnxt_iface_borrowed<T>(static_cast<void *>(View), nullptr);");
  Builder.append("  }");
  Builder.append("  void reset(T *P = nullptr) {");
  Builder.append("    if (View == P)");
  Builder.append("      return;");
  Builder.append("    __cnxt_rt_own_v1_unique_drop(Storage, Dtor, Size, Align);");
  Builder.append("    Storage = static_cast<void *>(P);");
  Builder.append("    View = P;");
  Builder.append("    if (P) {");
  Builder.append("      Dtor = __cnxt_payload_dtor<T>();");
  Builder.append("      Size = __cnxt_payload_size<T>();");
  Builder.append("      Align = __cnxt_payload_align<T>();");
  Builder.append("    } else {");
  Builder.append("      Dtor = nullptr;");
  Builder.append("      Size = 0;");
  Builder.append("      Align = 0;");
  ...
  Builder.append("unique<T> make(Args&&... InitArgs) {");
  ...
  Builder.append("    ::new (Storage) T{static_cast<Args&&>(InitArgs)...};");
  Builder.append("    Result.reset(Storage);");
  Builder.append("  }");
  Builder.append("  return Result;");
  Builder.append("}");
  Builder.append("template <typename T> unique<T> make_unique(T Value) {");
  Builder.append("  return make<T>(static_cast<T&&>(Value));");
  Builder.append("}");
  Builder.append("template <typename T> shared<T> share(unique<T> &&Owner);");
  Builder.append("template <typename T> struct shared {");
  Builder.append("private:");
  Builder.append("  void *Control = nullptr;");
  Builder.append("  T *View = nullptr;");
  Builder.append("  explicit shared(void *RawControl, T *RawView, int)");
  Builder.append("      : Control(RawControl), View(RawView) {}");
  Builder.append("  template <typename U> friend struct shared;");
  Builder.append("  template <typename U> friend struct weak;");
  Builder.append("  friend struct weak<T>;");
  Builder.append("  template <typename U> friend shared<U> share(unique<U> &&Owner);");
  Builder.append("public:");
  Builder.append("  shared() = default;");
  Builder.append("  shared(const shared &Other)");
  Builder.append("      : Control(Other.Control), View(Other.View) {");
  Builder.append("    __cnxt_rt_own_v1_shared_retain(Control);");
  Builder.append("  }");
  Builder.append("  template <typename U,");
  Builder.append("            typename = decltype(static_cast<T *>(");
  Builder.append("                static_cast<U *>(nullptr)))>");
  Builder.append("  shared(const shared<U> &Other)");
  Builder.append("      : Control(Other.Control), View(static_cast<T *>(Other.View)) {");
  Builder.append("    __cnxt_rt_own_v1_shared_retain(Control);");
  Builder.append("  }");
  Builder.append("  shared(shared &&Other) : Control(Other.Control), View(Other.View) {");
  Builder.append("    Other.Control = nullptr;");
  Builder.append("    Other.View = nullptr;");
  Builder.append("  }");
  Builder.append("  template <typename U,");
  Builder.append("            typename = decltype(static_cast<T *>(");
  Builder.append("                static_cast<U *>(nullptr)))>");
  Builder.append("  shared(shared<U> &&Other)");
  Builder.append("      : Control(Other.Control), View(static_cast<T *>(Other.View)) {");
  Builder.append("    Other.Control = nullptr;");
  Builder.append("    Other.View = nullptr;");
  Builder.append("  }");
  Builder.append("  ~shared() { __cnxt_rt_own_v1_shared_release(Control); }");
  Builder.append("  shared &operator=(const shared &Other) {");
  Builder.append("    if (this == &Other)");
  Builder.append("      return *this;");
  Builder.append("    __cnxt_rt_own_v1_shared_retain(Other.Control);");
  Builder.append("    __cnxt_rt_own_v1_shared_release(Control);");
  Builder.append("    Control = Other.Control;");
  Builder.append("    View = Other.View;");
  Builder.append("    return *this;");
  Builder.append("  }");
  Builder.append("  shared &operator=(shared &&Other) {");
  Builder.append("    if (this == &Other)");
  Builder.append("      return *this;");
  Builder.append("    __cnxt_rt_own_v1_shared_release(Control);");
  Builder.append("    Control = Other.Control;");
  ...
  Builder.append("            typename = decltype(static_cast<T *>(");
  Builder.append("                static_cast<U *>(nullptr)))>");
  Builder.append("  shared &operator=(shared<U> &&Other) {");
  Builder.append("    __cnxt_rt_own_v1_shared_release(Control);");
  Builder.append("    Control = Other.Control;");
  Builder.append("    View = static_cast<T *>(Other.View);");
  Builder.append("    Other.Control = nullptr;");
  ...
  Builder.append("  }");
  Builder.append("  void reset(T *P = nullptr) {");
  Builder.append("    (void)P;");
  Builder.append("    __cnxt_rt_own_v1_shared_release(Control);");
  Builder.append("    Control = nullptr;");
  Builder.append("    View = nullptr;");
  Builder.append("  }");
  Builder.append("  long use_count() const { return get() ? 1 : 0; }");
  Builder.append("};");
  Builder.append("template <typename T> shared<T> share(unique<T> &&Owner) {");
  Builder.append("  T *View = Owner.__view();");
  Builder.append("  void (*Dtor)(void *) = Owner.__dtor();");
  Builder.append("  unsigned long long Size = Owner.__size();");
  Builder.append("  unsigned long long Align = Owner.__align();");
  Builder.append("  void *Control = __cnxt_rt_own_v1_shared_from_unique(");
  Builder.append("      Owner.__release_storage(), Dtor, Size, Align);");
  Builder.append("  return shared<T>(Control, View, 0);");
  Builder.append("}");
  Builder.append("template <typename T> struct weak {");
  Builder.append("private:");
  Builder.append("  void *Control = nullptr;");
  ...
  Builder.append("  template <typename U> friend struct weak;");
  Builder.append("public:");
  Builder.append("  weak() = default;");
  Builder.append("  weak(const weak &Other)");
  Builder.append("      : Control(Other.Control), View(Other.View) {");
  Builder.append("    __cnxt_rt_own_v1_weak_retain(Control);");
  Builder.append("  }");
  Builder.append("  template <typename U,");
  Builder.append("            typename = decltype(static_cast<T *>(");
  Builder.append("                static_cast<U *>(nullptr)))>");
  Builder.append("  weak(const weak<U> &Other)");
  Builder.append("      : Control(Other.Control), View(static_cast<T *>(Other.View)) {");
  Builder.append("    __cnxt_rt_own_v1_weak_retain(Control);");
  Builder.append("  }");
  Builder.append("  weak(weak &&Other) : Control(Other.Control), View(Other.View) {");
  Builder.append("    Other.Control = nullptr;");
  Builder.append("    Other.View = nullptr;");
  Builder.append("  }");
  Builder.append("  template <typename U,");
  Builder.append("            typename = decltype(static_cast<T *>(");
  Builder.append("                static_cast<U *>(nullptr)))>");
  Builder.append("  weak(weak<U> &&Other)");
  Builder.append("      : Control(Other.Control), View(static_cast<T *>(Other.View)) {");
  Builder.append("    Other.Control = nullptr;");
  Builder.append("    Other.View = nullptr;");
  Builder.append("  }");
  Builder.append("  ~weak() { __cnxt_rt_own_v1_weak_release(Control); }");
  Builder.append("  weak &operator=(const weak &Other) {");
  Builder.append("    if (this == &Other)");
  Builder.append("      return *this;");
  Builder.append("    __cnxt_rt_own_v1_weak_retain(Other.Control);");
  Builder.append("    __cnxt_rt_own_v1_weak_release(Control);");
  Builder.append("    Control = Other.Control;");
  Builder.append("    View = Other.View;");
  Builder.append("    return *this;");
  Builder.append("  }");
  Builder.append("  weak &operator=(weak &&Other) {");
  Builder.append("    if (this == &Other)");
  Builder.append("      return *this;");
  Builder.append("    __cnxt_rt_own_v1_weak_release(Control);");
  Builder.append("    Control = Other.Control;");
  ...
  Builder.append("            typename = decltype(static_cast<T *>(");
  Builder.append("                static_cast<U *>(nullptr)))>");
  Builder.append("  weak &operator=(weak<U> &&Other) {");
  Builder.append("    __cnxt_rt_own_v1_weak_release(Control);");
  Builder.append("    Control = Other.Control;");
  Builder.append("    View = static_cast<T *>(Other.View);");
  Builder.append("    Other.Control = nullptr;");
  ...
  Builder.append("    return *this;");
  Builder.append("  }");
  Builder.append("  weak(const shared<T> &Owner)");
  Builder.append("      : Control(Owner.Control), View(Owner.View) {");
  Builder.append("    __cnxt_rt_own_v1_weak_retain(Control);");
  Builder.append("  }");
  Builder.append("  template <typename U,");
  Builder.append("            typename = decltype(static_cast<T *>(");
  Builder.append("                static_cast<U *>(nullptr)))>");
  Builder.append("  weak(const shared<U> &Owner)");
  Builder.append("      : Control(Owner.Control), View(static_cast<T *>(Owner.View)) {");
  Builder.append("    __cnxt_rt_own_v1_weak_retain(Control);");
  Builder.append("  }");
  Builder.append("  shared<T> lock() const {");
  Builder.append("    void *Locked = __cnxt_rt_own_v1_weak_lock(Control);");
  Builder.append("    return shared<T>(Locked, Locked ? View : nullptr, 0);");
  Builder.append("  }");
  Builder.append("  bool expired() const {");
  Builder.append("    return __cnxt_rt_own_v1_weak_expired(Control) != 0;");
  Builder.append("  }");
  Builder.append("};");
